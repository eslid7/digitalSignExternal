...
;(function ( $, window, document, undefined ) {
    ...
    var pluginName = "isLoading",
        defaults = {
            ...
            'tpl': '<span class="isloading-wrapper %wrapper%"><div id="loading-div"><img src="/includes/resources/static/img/ajax_modal_loading.gif" ><p style="color:white;">%text%</p></div></span>',    // loader base Tag
